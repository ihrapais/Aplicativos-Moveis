...
class $LeitoresTable extends Leitores with TableInfo<$LeitoresTable, Leitor> {
  ...
  late final GeneratedColumn<String> generoLiterarioPreferido =
      GeneratedColumn<String>('genero_literario_preferido', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  ...
  late final GeneratedColumn<String> frequenciaParticipacao =
      GeneratedColumn<String>('frequencia_participacao', aliasedName, true,
          type: DriftSqlType.string, requiredDuringInsert: false);
  static const VerificationMeta _dataInscricaoMeta =
      const VerificationMeta('dataInscricao');
  @override
  late final GeneratedColumn<DateTime> dataInscricao =
      GeneratedColumn<DateTime>('data_inscricao', aliasedName, false,
  ...
  @override
  VerificationContext validateIntegrity(Insertable<Leitor> instance,
    ...
    if (data.containsKey('frequencia_participacao')) {
      context.handle(
          ...
          frequenciaParticipacao.isAcceptableOrUnknown(
              data['frequencia_participacao']!, _frequenciaParticipacaoMeta));
    }
    if (data.containsKey('data_inscricao')) {
      context.handle(
          _dataInscricaoMeta,
          dataInscricao.isAcceptableOrUnknown(
              data['data_inscricao']!, _dataInscricaoMeta));
    } else if (isInserting) {
  ...
  Leitor map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Leitor(
      ...
      dataInscricao: attachedDatabase.typeMapping.read(
          DriftSqlType.dateTime, data['${effectivePrefix}data_inscricao'])!,
    );
  }
...
class Leitor extends DataClass implements Insertable<Leitor> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || generoLiterarioPreferido != null) {
      map['genero_literario_preferido'] =
          Variable<String>(generoLiterarioPreferido);
    }
  ...
  factory Leitor.fromJson(Map<String, dynamic> json,
    ...
    return Leitor(
      ...
      generoLiterarioPreferido:
          serializer.fromJson<String?>(json['generoLiterarioPreferido']),
      frequenciaParticipacao:
          serializer.fromJson<String?>(json['frequenciaParticipacao']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'generoLiterarioPreferido':
          serializer.toJson<String?>(generoLiterarioPreferido),
      'frequenciaParticipacao':
          serializer.toJson<String?>(frequenciaParticipacao),
  ...
  @override
  int get hashCode => Object.hash(id, nome, email, telefone,
      generoLiterarioPreferido, frequenciaParticipacao, dataInscricao);
  @override
...
class LeitoresCompanion extends UpdateCompanion<Leitor> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (generoLiterarioPreferido.present) {
      map['genero_literario_preferido'] =
          Variable<String>(generoLiterarioPreferido.value);
    }
    if (frequenciaParticipacao.present) {
      map['frequencia_participacao'] =
          Variable<String>(frequenciaParticipacao.value);
    }
...
typedef $$LeitoresTableCreateCompanionBuilder = LeitoresCompanion Function({
  Value<int> id,
  required String nome,
  required String email,
  Value<String?> telefone,
...
typedef $$LeitoresTableUpdateCompanionBuilder = LeitoresCompanion Function({
  Value<int> id,
  Value<String> nome,
  Value<String> email,
  Value<String?> telefone,
...
class $$LeitoresTableFilterComposer
  ...
  ColumnFilters<DateTime> get dataInscricao => $composableBuilder(
      column: $table.dataInscricao, builder: (column) => ColumnFilters(column));
}
...
class $$LeitoresTableAnnotationComposer
  ...
  GeneratedColumn<String> get generoLiterarioPreferido => $composableBuilder(
      column: $table.generoLiterarioPreferido, builder: (column) => column);

  GeneratedColumn<String> get frequenciaParticipacao => $composableBuilder(
      column: $table.frequenciaParticipacao, builder: (column) => column);

  GeneratedColumn<DateTime> get dataInscricao => $composableBuilder(
      column: $table.dataInscricao, builder: (column) => column);
}

class $$LeitoresTableTableManager extends RootTableManager<
    _$AppDatabase,
    $LeitoresTable,
    Leitor,
    $$LeitoresTableFilterComposer,
...
typedef $$LeitoresTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $LeitoresTable,
    Leitor,
    $$LeitoresTableFilterComposer,
